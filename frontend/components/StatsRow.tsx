...
import { Job, StartupJob, IndeedJob, ScraperRun } from "@/lib/api";
...
export default function StatsRow({ linkedinJobs, startupJobs, indeedJobs, runs = [] }: Props) {
  const stats = [
    ...
    { label: "Avg Duration",   value: avgDuration(runs),    color: "text-amber-700",  bg: "bg-amber-50 border-amber-200" },
  ];
